...
export default function AIReadySchools() {
  return (
    <div className="min-h-screen bg-background">
      <SEO title="AI-Ready Schools | Center for AI Services | ACES PDSI" description="Build the policy, professional learning, and leadership strategy that prepare schools and districts to use AI responsibly." />
      <Header />
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold text-foreground leading-tight mb-5">AI-Ready Schools</h1>
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed max-w-xl">
                Help your school or district build the foundation — policies, professional learning, and leadership strategy — to bring AI into practice with care.
              </p>
              <div className="flex flex-wrap gap-3">
                <Button asChild size="lg" className="gradient-aces text-white rounded-full px-7">
                  <Link to="/workshops-events">Professional Learning & Workshops</Link>
                </Button>
            ...
            <motion.div initial={{ opacity: 0, scale: 0.96 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.6, delay: 0.15 }}>
              <div className="rounded-3xl overflow-hidden shadow-2xl bg-card p-3">
                <img src={heroImg} alt="School leadership team planning AI adoption" className="w-full aspect-[4/3] object-cover rounded-2xl" />
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mb-12">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-heading font-bold text-foreground mb-4 leading-tight">Four pillars of readiness</h2>
            <p className="text-lg text-muted-foreground">A practical framework for districts beginning — or maturing — AI work.</p>
          </div>
      ...
      <section className="py-20 bg-secondary">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              <div className="text-xs font-bold tracking-[0.2em] uppercase text-accent mb-3">Readiness checklist</div>
              <h2 className="text-3xl md:text-4xl font-heading font-bold text-foreground mb-4 leading-tight">What ready schools have in place</h2>
              <p className="text-muted-foreground leading-relaxed">A few markers we look for when supporting district AI adoption.</p>
            </div>
      ...
      <section className="py-16 md:py-20 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
          <div className="max-w-2xl">
            <h2 className="text-3xl md:text-4xl font-heading font-bold mb-3 leading-tight">Build an AI-ready school community</h2>
            <p className="text-primary-foreground/80">From first conversation to district-wide rollout, ACES PDSI partners with you the whole way.</p>
          </div>
          <div className="flex flex-wrap gap-3">
